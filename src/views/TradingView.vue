...
<template>
  <GridLayout
    class="ft-trading-layout h-full w-full"
    style="padding: 1px"
    :row-height="50"
    ...
    <template #default="{ gridItemProps }">
      ...
      >
        <DraggableContainer header="Multi Pane">
          <div class="ft-trade-multipane">
            <div class="ft-trade-multipane-controls">
              <BotControls />
            </div>
            <Tabs class="ft-trade-multipane-tabs" value="0" scrollable lazy>
              <TabList>
